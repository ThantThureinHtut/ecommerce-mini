...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn("text-muted-foreground group-focus/dropdown-menu-item:text-[color:var(--dropdown-accent-foreground)] ml-auto text-xs tracking-widest", className)}
      {...props}
    />
  )
}
